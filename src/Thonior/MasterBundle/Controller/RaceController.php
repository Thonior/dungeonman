...
use Thonior\MasterBundle\Entity\Race;
use Thonior\MasterBundle\Form\RaceType;
...
class RaceController extends myController
{
	...
	$races = $universe->getRaces();
        
        $vars = array( 'entities' => $races);
     ...
     * @Method("POST")
     * @Template("ThoniorMasterBundle:Race:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id, Request $request)
    {
        ...
        $entity = $em->getRepository('ThoniorMasterBundle:Race')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ThoniorMasterBundle:Race:edit.html.twig")
     */
